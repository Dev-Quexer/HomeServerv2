package me.quexer.homeserverv2.homebackend.builder.inventory;


import me.quexer.homeserverv2.homebackend.HomeBackend;
import me.quexer.homeserverv2.homebackend.listeners.ItemListener;
...
public class InventoryBuilder {
    ...
    public InventoryBuilder addListener(ItemListener listener) {
        HomeBackend.getInventoryHandler().registerListener(this.inventory, listener);
        return this;
    }
