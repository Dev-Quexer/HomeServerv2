package me.quexer.homeserverv2.homebackend;

import com.google.gson.Gson;
import me.quexer.homeserverv2.homebackend.api.LocationAPI;
import me.quexer.homeserverv2.homebackend.api.NickAPI;
import me.quexer.homeserverv2.homebackend.backend.BackendListeners;
import me.quexer.homeserverv2.homebackend.builder.inventory.InventoryHandler;
import me.quexer.homeserverv2.homebackend.commands.*;
import me.quexer.homeserverv2.homebackend.database.AsyncMySQL;
import me.quexer.homeserverv2.homebackend.database.MongoManager;
import me.quexer.homeserverv2.homebackend.manager.BackendManager;
import me.quexer.homeserverv2.homebackend.manager.BackendPlayerManager;
import me.quexer.homeserverv2.homebackend.manager.EventManager;
import me.quexer.homeserverv2.homebackend.manager.SoundManager;
...
public final class HomeBackend extends JavaPlugin {

    private static HomeBackend instance;
    ...
    private static BackendListeners backendListeners;
    private static BackendManager backendManager;
    private static BackendPlayerManager backendPlayerManager;
    ...
    private void init() {
        setInstance(this);
        setGson(new Gson());
        setMongoManager(new MongoManager("localhost", 27017, "HomeServerV2"));
        ...
        setBackendListeners(new BackendListeners());
        setBackendManager(new BackendManager());
        setBackendPlayerManager(new BackendPlayerManager());
        ...
        Bukkit.getPluginCommand("group").setExecutor(new GroupCMD());
        registerNicks();
        Tablist.load();
    ...
    public static BackendPlayerManager getBackendPlayerManager() {
        return backendPlayerManager;
    }

    public static void setBackendPlayerManager(BackendPlayerManager backendPlayerManager) {
        HomeBackend.backendPlayerManager = backendPlayerManager;
    }

    public static BackendListeners getBackendListeners() {
        return backendListeners;
    }

    public static void setBackendListeners(BackendListeners backendListeners) {
        HomeBackend.backendListeners = backendListeners;
    }
    ...
    public static void setBackendManager(BackendManager backendManager) {
        HomeBackend.backendManager = backendManager;
    }

    public static HomeBackend getInstance() {
        return instance;
    }

    public static void setInstance(HomeBackend instance) {
        HomeBackend.instance = instance;
    }
    ...
    public static void setMongoManager(MongoManager mongoManager) {
        HomeBackend.mongoManager = mongoManager;
    }
    ...
    public static void setAsyncMySQL(AsyncMySQL asyncMySQL) {
        HomeBackend.asyncMySQL = asyncMySQL;
    }
    ...
    public static void setLocationAPI(LocationAPI locationAPI) {
        HomeBackend.locationAPI = locationAPI;
    }
    ...
    public static void setInventoryHandler(InventoryHandler inventoryHandler) {
        HomeBackend.inventoryHandler = inventoryHandler;
    }
    ...
    public static void setCoinsPrefix(String coinsPrefix) {
        HomeBackend.coinsPrefix = coinsPrefix;
    }
    ...
    public static void setSoundManager(SoundManager soundManager) {
        HomeBackend.soundManager = soundManager;
    }
    ...
    public static void setEventManager(EventManager eventManager) {
        HomeBackend.eventManager = eventManager;
    }
    ...
    public static void setNickOnThisServer(boolean nickOnThisServer) {
        HomeBackend.nickOnThisServer = nickOnThisServer;
    }
    ...
    public static void setSetTablist(boolean setTablist) {
        HomeBackend.setTablist = setTablist;
    }
}
